 ...
 * @author renat
 */
public class ManterCadastros extends javax.swing.JFrame {
    private boolean novoCadastro = false;
    private boolean funcionarios = false;
    
    /**
     * Creates new form ManterClientes
     */
    private ManterCadastros() {
        initComponents();
    ...
    public ManterCadastros(boolean funcionarios){       
        this();
    ...
    private void tabelaClientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaClientesMouseClicked
        ...
        if (campoCPF.getText().equals(Session.getUser().getCpf()))
            botaoRemover.setEnabled(false);
        else
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManterCadastros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManterCadastros().setVisible(true);
            }
        });
    }
    ...
    private void carregarClientes() {
        ...
        try {
            ...
            if (funcionarios)
                clientes = clienteDAO.findAllFuncionario();
            else
    ...
    private void arrumarCadastro(){
        if (novoCadastro){
            ...
            campoEmail.setText("");
            if (funcionarios)
                labelTitle.setText("Novo cadastro de funcionário:");
            else
